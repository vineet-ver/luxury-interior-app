                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-center">
                        ...
                        >
                            ...
                            <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-luxury-onyx/70 max-w-xl leading-relaxed mb-12 border-l-2 border-luxury-gold/30 pl-8 font-light">
                                ITSS is a leading <Link href="/services"><strong strong className="text-luxury-gold">commercial interior design company in India</strong></Link> delivering <strong>turnkey office, corporate, and retail interior solutions</strong>for premium enterprises across India.
                            </motion.p>
